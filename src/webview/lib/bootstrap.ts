...
const handlers: Handlers = {
  ...
  commitChanges: handleActionResult,
  ...
  pullCurrentBranch: handleActionResult,
  pushCurrentBranch: handleActionResult,
  pushTag: handleActionResult,
  rebaseBranch: handleActionResult,
  renameBranch: handleActionResult,
  resetToCommit: handleActionResult,
  revertCommit: handleActionResult,
  stageAll: handleActionResult,
  stageFiles: handleActionResult,
  unstageAll: handleActionResult,
  unstageFiles: handleActionResult,
