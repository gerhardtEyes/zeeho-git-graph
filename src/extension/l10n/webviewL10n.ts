...
export function getWebviewLocalizedStrings() {
  return {
    ...
    treeView: vscode.l10n.t("Tree"),
    flatView: vscode.l10n.t("List"),
    switchToTreeView: vscode.l10n.t("Switch to tree view"),
    switchToFlatView: vscode.l10n.t("Switch to list view"),
    filterByFileType: vscode.l10n.t("Filter by file type"),
    allFileTypes: vscode.l10n.t("All types"),
    noFileExtension: vscode.l10n.t("No extension"),
    showOnlyCSharpFiles: vscode.l10n.t("Show only C# files"),
    filteredFileCount: vscode.l10n.t("{0}/{1}"),
    noFilesMatchFilter: vscode.l10n.t("No files match the current filter."),
